...
/***********************************************************************************************************************
* Function Name: HS300x_Start_Measure
* Description  : This function is used to measure the temperature and humidity
* Arguments    : None
* Return Value : read status.
***********************************************************************************************************************/
uint8_t HS300x_Start_Measure(void)
{
	uint8_t status = MD_OK;
	uint8_t data_tr = 0, i = 0;
	status = R_IICA0_Master_Send(	0x88 ,
				&data_tr, 
				0, 
				0x0);
	return status;
...
/***********************************************************************************************************************
* Function Name: HS300x_Read_Humidity_Temperature
* Description  : This function is used to measure the temperature and humidity
* Arguments    : data - 
			point to receive temperature and humidity. 
* Return Value : true
***********************************************************************************************************************/
uint8_t HS300x_Read_Humidity_Temperature(uint8_t * data)
{	
	uint16_t num_get = 4, i = 0;	
	R_IICA0_Master_Receive(	0x89,
				data, 
				num_get, 
				0xF);
	for ( i=0; i<=0xfff; i++ );
